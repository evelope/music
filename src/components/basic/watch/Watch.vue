<template>
  <svg
    ...
    width="60%"
    height="60%"
    viewBox="94.257 101.184 300 300"
    enable-background="new 94.257 101.184 300 300"
    xml:space="preserve"
  >
    <circle id="face" fill="#F4F3ED" cx="243.869" cy="250.796" r="130.5"></circle>
    <path
      id="rim"
      fill="#383838"
    ...
    <g id="markings">
      ...
      <rect x="282" y="152.98" fill="none" width="17.366" height="27.947"></rect>
      <text
        ...
        font-size="26"
      >1</text>
      <rect x="320.699" y="188.474" fill="none" width="17.202" height="26.267"></rect>
      <text
        ...
        font-size="26"
      >2</text>
      <rect x="335.04" y="238.872" fill="none" width="21.03" height="24.585"></rect>
      <text
        ...
        font-size="26"
      >3</text>
      <rect x="319.699" y="290.242" fill="none" width="17.202" height="23.557"></rect>
      <text
        ...
        font-size="26"
      >4</text>
      <rect x="284.5" y="323.319" fill="none" width="19.212" height="22.511"></rect>
      <text
        ...
        font-size="26"
      >5</text>
      <rect x="235.552" y="336.08" fill="none" width="19.938" height="24.15"></rect>
      <text
        ...
        font-size="26"
      >6</text>
      <rect x="189.373" y="322.319" fill="none" width="19.673" height="25.003"></rect>
      <text
        ...
        font-size="26"
      >7</text>
      <rect x="151.066" y="287.539" fill="none" width="17.726" height="25.203"></rect>
      <text
        ...
        font-size="26"
      >8</text>
      <rect x="136.392" y="241.25" fill="none" width="20.696" height="22.348"></rect>
      <text
        ...
        font-size="26"
      >9</text>
      <rect x="149.066" y="191.474" fill="none" width="36.554" height="27.122"></rect>
      <text
        ...
        font-size="26"
      >10</text>
      <rect x="184.967" y="158.518" fill="none" width="36.021" height="27.13"></rect>
      <text
        ...
        font-size="26"
      >11</text>
      <rect x="225.723" y="144.514" fill="none" width="37.029" height="29.25"></rect>
      <text
